...
if [ -d kicad.bzr ]; then
    ...
    git clone --depth 1 https://git.launchpad.net/kicad kicad.bzr
fi
...
if [ -d kicad-library.bzr ]; then
    ...
    git clone --depth 1 https://github.com/KiCad/kicad-library.git kicad-library.bzr
fi
...
if [ -d kicad-i18n ]; then
    ...
    git clone --depth 1 https://github.com/KiCad/kicad-i18n.git
fi
